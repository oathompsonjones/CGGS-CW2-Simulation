...
class Scene {
   public:
    ...
    void create_ASolver(double timeStep) {
    ...
    void init_scene(double _timeStep, const double _alpha, const double _beta) {
        timeStep = _timeStep;
        alpha = _alpha;
        beta = _beta;
        create_ASolver(timeStep);
    }
